...
import { ownerUpdateAdjudicationReview, saveAllCategoryProposals, submitPanelForOwnerReview, type CategoryProposalSaveResult } from "@/app/portal/adjudication/[id]/workflow-actions";
...
export function AdjudicationConsensusBar({ applicationId, role, categories, proposals, review, narrativesReady }: { applicationId: string; role: AppRole; currentUserId: string; categories: ScoringCategory[]; proposals: Proposal[]; approvals: unknown[]; review: Review; narrativesReady: boolean }) {
  ...
  return (
    <>
      ...
      {categorySaveResult.ok && categorySaveResult.message && (
        <div aria-live="polite" className="notice-banner success-banner page-message" role="status">
